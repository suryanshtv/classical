...
module.exports = {
    async base(title, artist, durationMS, link, thumbnail) {
        ...
        // Create the canvas
        registerFont('./src/mapping/fonts/NotoColorEmoji.ttf', { family: 'Emoji' });
        registerFont('./src/mapping/fonts/SamsungColorEmoji.ttf', { family: 'Emoji' });
        ...
        ctx.font = '26px "Rubik", "Poppins", "Noto", "Emoji"';
    ...
    async spotifyPlaylist(title, length, author) {
        ...
        ctx.font = '22px "Rubik", "Poppins", "Noto", "Emoji"';
    ...
    async spotifyTrack(searched, author) {
        ...
        ctx.drawImage(overlay, 0, 0, canvas.width, canvas.height);
        ctx.font = '23px "Rubik", "Poppins", "Noto", "Emoji"';
